...
export function setGallery(props, scope) {
  ...
  const mergedGalleries = props.galleries.mergedGalleries;
  const galleries = props.auth.authenticated && Object.keys(mergedGalleries).length > 0 ? mergedGalleries : props.galleries.galleries;
