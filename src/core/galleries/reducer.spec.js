...
import { initialState, galleriesReducer } from './reducer';
...
describe('Tasks reducer', () => {
  ...
  it('should return the initial state when action.type is not found', () => {
    expect(galleriesReducer(undefined, {})).toEqual(getInitialState());
  });
  ...
  describe('CREATE_TASK_SUCCESS', () => {
    it('should prepend new task to list', () => {
      ...
      let nextState = galleriesReducer(state, {
